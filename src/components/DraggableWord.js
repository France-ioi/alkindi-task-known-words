...
export const DraggableWord = ({word, wordIndex}) => {
  ...
  return (
    <div ref={ref} className="draggable-word letter-cell" style={{opacity, marginBottom: '2px'}}>
      ...
      <span className="draggable-word-value">{word}</span>
    </div>
  );
};
